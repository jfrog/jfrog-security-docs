...
#### Runtime Integrity Added to JFrog Advanced Security Bundle

**Runtime Integrity** has been added to the **Advanced Security** bundle, expanding the suite’s runtime protection and security coverage.
