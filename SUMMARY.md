...
* [Products](products/README.md)
  ...
  * [Xray](products/xray-1/README.md)
    * [Xray Supported Technologies](products/xray-1/xray-supported-technologies.md)
    * [Xray Features and Capabilities](products/xray-1/xray-features-and-capabilities/README.md)
      * [SCA](products/xray-1/xray-features-and-capabilities/sca/README.md)
        * [Security](products/xray-1/xray-features-and-capabilities/sca/security/README.md)
          * [JFrog Security Research](products/xray-1/xray-features-and-capabilities/sca/security/jfrog-security-research.md)
          * [Malicious Package Detection](products/xray-1/xray-features-and-capabilities/sca/security/malicious-package-detection.md)
        * [Legal](products/xray-1/xray-features-and-capabilities/sca/legal.md)
        * [Operational Risk](products/xray-1/xray-features-and-capabilities/sca/operational-risk.md)
        * [SBOM](products/xray-1/xray-features-and-capabilities/sca/sbom/README.md)
          * [SBOM Import](products/xray-1/xray-features-and-capabilities/sca/sbom/sbom-import.md)
          * [SBOM Export](products/xray-1/xray-features-and-capabilities/sca/sbom/sbom-export.md)
      * [Policies in JFrog Xray](products/xray-1/xray-features-and-capabilities/sdlc-policy-mangement/README.md)
        * [Watches in JFrog Xray](products/xray-1/xray-features-and-capabilities/sdlc-policy-mangement/watches.md)
        * [Ignoring Violations in JFrog Xray: Understanding Ignore Rules](products/xray-1/xray-features-and-capabilities/sdlc-policy-mangement/ignore-rules.md)
      * [Export Scan Results](products/xray-1/xray-features-and-capabilities/export-scan-results.md)
      * [Understanding and Analyzing Xray Scan Results](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/README.md)
        * [Builds](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/builds/README.md)
          * [Builds Security Overview](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/builds/builds-security-overview.md)
          * [Comparing Build Versions](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/builds/comparing-build-versions.md)
        * [Violations Handling and Notifications](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/README.md)
          * [Jira Integration](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/README.md)
            * [Setup Xray Jira Integration](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/setup-xray-jira-integration.md)
            * [View Jira Tickets Created with Xray Integration](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/view-jira-tickets-created-with-xray-integration.md)
            * [Manually Create a Jira Ticket](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/manually-create-a-jira-ticket.md)
            * [Ticket Status](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/ticket-status.md)
            * [Best Practices](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/best-practices.md)
            * [Xray Jira Integration REST API Support](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/jira-integration/xray-jira-integration-rest-api-support.md)
          * [Webhooks](products/xray-1/xray-features-and-capabilities/understanding-and-analyzing-xray-scan-results/violations-handling-and-notifications/webhooks.md)
      * [Xray Reports](products/xray-1/xray-features-and-capabilities/reports.md)
    * [Quick Start](products/xray-1/quick-start.md)
    * [Configure Xray](products/xray-1/configure-xray/README.md)
      * [Index Xray Resources](products/xray-1/configure-xray/index-xray-resources/README.md)
        * [Configure Indexing in JFrog Xray](products/xray-1/configure-xray/index-xray-resources/configure-indexing-in-jfrog-xray.md)
        * [Set a Retention Period for Xray Indexed Resources](products/xray-1/configure-xray/index-xray-resources/retention-period.md)
      * [Create Watches](products/xray-1/configure-xray/create-watches.md)
      * [Create Policies](products/xray-1/configure-xray/create-policies.md)
    * [Manage Xray](products/xray-1/xray-management/README.md)
      * [Xray <--> JFrog External DB Sync](products/xray-1/xray-management/xray-less-than-greater-than-jfrog-external-db-sync.md)
      * [Migration Guide for Self-Hosted Customers: Upgrading from DBSync V1 to V3](products/xray-1/xray-management/migration-guide-for-self-hosted-customers-upgrading-from-dbsync-v1-to-v3.md)
      * [Advanced Settings](products/xray-1/xray-management/advanced-settings.md)
      * [Custom Software Licenses](products/xray-1/xray-management/custom-licenses.md)
      * [System Monitoring](products/xray-1/xray-management/system-monitoring.md)
      * [TLS Certificates](products/xray-1/xray-management/tls-certificates.md)
    * [Xray How-Tos](products/xray-1/xray-how-tos/README.md)
      * [How to Filter Out Your 1st Party Components in CycloneDX SBOM report](products/xray-1/xray-how-tos/how-to-filter-1st-party-components.md)
      * [How to Detect Malicious AI Models using Xray](products/xray-1/xray-how-tos/how-to-detect-malicious-ai-models-using-xray.md)
      * [How to Assign Supplier to your resources in SBOM reports](products/xray-1/xray-how-tos/how-to-assign-supplier-to-your-resources-in-sbom-reports.md)
      * [How to Block Malicious Packages in your SDLC](products/xray-1/xray-how-tos/how-to-block-malicious-packages-in-your-sdlc.md)
      * [How to Block Critical and High Vulnerabilities Before Promotion](products/xray-1/xray-how-tos/how-to-block-critical-and-high-vulnerabilities-before-promotion.md)
      * [How to Create a Violation for a Specific Package Version](products/xray-1/xray-how-tos/how-to-create-a-violation-for-a-specific-package-version.md)
      * [How to Send Email Notifications for Each Critical Vulnerability Found in Resource](products/xray-1/xray-how-tos/how-to-send-email-notifications-for-each-critical-vulnerability-found-in-resource.md)
      * [How to Generate a Report with All Vulnerabilities in a Distributed Bundle](products/xray-1/xray-how-tos/how-to-generate-a-report-with-all-vulnerabilities-in-a-distributed-bundle.md)
      * [How to Generate a Report with All Used Licenses in Your Environment Using JFrog Xray](products/xray-1/xray-how-tos/how-to-generate-a-report-with-all-used-licenses-in-your-environment-using-jfrog-xray.md)
