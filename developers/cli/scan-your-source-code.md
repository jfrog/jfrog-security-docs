...
| --exclusions                  | No       | .git, node\_modules, target, venv, test, and dist | Semicolon-separated list to exclude specific directories. Supports wildcards (\*, ?). You may override the default exclusions by explicitly setting your own list using the `--exclusions` flag.                                                       |
...
| --use-included-builds         | No       | false                                             | Set to true to include composite (included) builds of Gradle projects in addition to their subprojects.                                                                                                                                                |
| --url                         | No       | false                                             | Specifies the URL of the JFrog platform                                                                                                                                                                                                                |
| --xray-url                    | No       | false                                             | Specifies the URL of your Xray server                                                                                                                                                                                                                  |
| --user                        | No       | false                                             | Specifies the user name                                                                                                                                                                                                                                |
| --password                    | No       | false                                             | Specifies the user password                                                                                                                                                                                                                            |
| --access-token                | No       | false                                             | Specifies the JFrog platform access token                                                                                                                                                                                                              |
