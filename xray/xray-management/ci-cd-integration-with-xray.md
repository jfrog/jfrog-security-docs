...
* **JFrog CLI**: To scan build artifacts for vulnerabilities using JFrog CLI, you need to use the [jf build-scan](../../source-code/developers/cli/scan-published-builds.md) command.
