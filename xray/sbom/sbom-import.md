...
Follow the procedure in [Enrich Your SBOM](../../source-code/developers/cli/enrich-your-sbom-jsons-and-xmls.md) to add Xray’s vulnerability and license data to an external SBOM using the JFrog CLI.
