...
Waiver management is supported on the JFrog CLI for Curation. For more information, see [here](../../source-code/developers/cli/curation-compliance-check.md#exclude-specific-packages-or-versions-from-policy-restrictions-using-waivers).
