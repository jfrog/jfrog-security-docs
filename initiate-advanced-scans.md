...
The [Repositories](advanced-security/configure-advanced-security/enable-advanced-scans/repositories.md) and [Artifacts](advanced-security/configure-advanced-security/enable-advanced-scans/artifacts.md) guides explain how to initiate and configure both **ongoing** and **one-time** advanced scans to detect:
