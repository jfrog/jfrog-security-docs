...
By leveraging JFrog’s security intelligence, Xray pinpoints vulnerabilities in both direct and transitive dependencies, mapping their impact and recommending optimal remediation paths.
...
**\*\* Upgrade Suggestions Gif** [Lina Daher](https://app.gitbook.com/u/KVHN3JywAyUPRzbfbJhUkiBQg3A2 "mention")
...
| **Curation Approved  -** Coming soon | Suggested version is approved to download by JFrog Curation policies           |
| **Policy Approved**  - Coming soon   | Suggested Version is pre-approved by the resource effective security policies  |

For deeper context on why certain vulnerabilities are introduced and how they propagate through your dependency tree, see [Transitive Dependency Analysis](../contextual-analysis-of-cves.md). This advanced feature complements remediation by showing the exact call chains and dependency paths that lead to a CVE, helping you validate and prioritize the suggested fixes.
