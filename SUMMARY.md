...
* [Shift Left on Security](shift-left-on-security/README.md)
  ...
  * [Frogbot](shift-left-on-security/frogbot/README.md)
    ...
    * [Configure Frogbot](shift-left-on-security/frogbot/configure-frogbot/README.md)
      * [Advanced Configuration](shift-left-on-security/frogbot/configure-frogbot/advanced-configuration/README.md)
        * [YAML File](shift-left-on-security/frogbot/configure-frogbot/advanced-configuration/yaml-file.md)
      * [The frogbot-config.yml File Structure](shift-left-on-security/frogbot/configure-frogbot/the-frogbot-config.yml-file-structure.md)
